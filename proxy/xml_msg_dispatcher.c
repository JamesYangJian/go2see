...
static S_XML_MSG_DISPATCHER dispatcher_list[] = 
{
    ...
    {E_PROGROM_INFO_CODE, program_info_request_handler},
    {E_PROGRAM_REQUEST_CODE, program_request_handler},
    {E_PROGRAM_REQUEST_NOTIFY_ACK_CODE, program_request_notify_ack_handler},
};
...
int xml_msg_dispatcher(char *pData, int len, void *pChannel)
{
    ...
    if (pChn->channel_type == E_CLIENT_CHANNEL && seq < pChn->required_seq)
    {
