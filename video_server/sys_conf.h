...
#define M_SYS_CONF_FILE     "/mnt/cfg/video_server.cfg"
...
typedef struct
{
    ...
    int       iVideoSvrPt;
    int       iVideoPort;
    int       iVideoChannelNum;
    char    szVideoProtocol[M_PROTOCOL_LEN+1];
    char    szProxyIP[M_IP_STR_LEN];
}SYS_CONFIG_DATA;
