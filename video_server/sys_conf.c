...
SYS_CONF_ITEM clist[] =
{
    ...
    {"Video_Protocol",               c_set_str,   &g_stConfigData.szVideoProtocol,            M_PROTOCOL_LEN},
    {"Video_Channel_Num",      c_set_uint,  &g_stConfigData.iVideoChannelNum,       sizeof(int)},
    {"Proxy_Server_IP",           c_set_str,   &g_stConfigData.szProxyIP,                     M_IP_STR_LEN-1},
    {"Video_Port",                    c_set_uint,  &g_stConfigData.iVideoPort,                    sizeof(int)},
...
{
    return (char *)g_stConfigData.szVideoSvrIP;
}
...
char *get_video_protocol()
{
    return (char *)g_stConfigData.szVideoProtocol;
}

int     get_video_channel_num()
{
    return g_stConfigData.iVideoChannelNum;
}

char *get_proxy_ip()
{
    return (char *)g_stConfigData.szProxyIP;
}

int get_video_port()
{
    return g_stConfigData.iVideoPort;
}
